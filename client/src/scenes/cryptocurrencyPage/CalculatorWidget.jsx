                ...
                `}>
                    ...
                    <div className="flex flex-col items-between mt-4 mb-3 mx-5">
                        ...
                        <div className="flex flex-row justify-around mt-6 mx-6">
                            <button onClick={handleSubmit} className="p-1 bg-[#062c43] w-[100px] border-[2px]  border-[#9ccddc] rounded-lg  text-[white] ">
                                Calculate
                            </button>
                            <button onClick={handleReset} className="p-1 ] w-[100px] border-[2px]  border-[#9ccddc] rounded-lg bg-[#062c43] text-[white] ">
                                Reset
                            </button>
                        </div>
