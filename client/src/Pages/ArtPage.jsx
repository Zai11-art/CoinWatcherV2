         ...
         xl:flex-row lg:flex-row md:flex-row flex-col-reverse mb-6"
          ...
          >
            ...
            <div className="flex w-[80%] mb-6">
              <h1 className="text-white font-semibold xl:text-3xl lg:text-2xl md:text-xl text-xl">
                <span className="text-[#76ff76] text-glow font-bold">Fresh Data. </span>
                Providing the latest information about different
                cryptocurrencies with a chart, available markets, specific news
                for each coins allowing a detailed monitoring of the coin.
              </h1>
            </div>
            <div className="flex w-[15%] flex-col glass p-2">
              <h1 className="text-[#76ff76] text-glow font-bold text-7xl">
                250+
              </h1>
              <p className="text-[#76ff76] text-glow font-thin">
                CRYPTOCURRENCIES
              </p>
            </div>
          </div>
