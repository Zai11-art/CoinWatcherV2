...
import TopCoinWidget from "../components/communitywidgets/TopCoinWidget";
import TrendingCoinWidget from "../components/communitywidgets/TrendingCoinWidget";
...
const CommunityPage = () => {
  ...
  return (
    <div className={`bg-[#061016] w-screen ${!_id ? "h-[2000px]" : "h-[100%]"} flex lg:flex-row md:flex-col flex-col justify-around lg:items-start md:items-center items-center xl:px-[10%] lg:px-[5%] md:px-6 px-2 py-12 `}>
      <div
        className="
        xl:h-[100%] xl:w-[60%]
        lg:h-[100%] lg:w-[60%]
